      ...
      <div className="bg-[#113A3A] w-full max-w-md p-8 rounded-2xl shadow-xl border border-[#1E5A5A]/40">
        ...
        {user ? (
          <div className="text-center text-gray-200">
            <img src={logo} alt="Gemlay" className="h-14 mx-auto opacity-90" />
            <p className="mt-4 text-lg">You are already logged in as</p>
            <p className="mt-1 text-teal-300 font-bold">{user.name}</p>

            <button
              onClick={handleLogout}
              className="w-full mt-6 py-3 bg-teal-300 text-black font-bold rounded-lg hover:bg-teal-200 transition-all"
            >
              Logout
            </button>
            ...
            <button
              onClick={() => navigate("/")}
              className="w-full mt-4 py-3 bg-[#0F2D2D] border border-teal-300 text-teal-300 font-medium rounded-lg hover:bg-[#134444]"
            >
              Go to Homepage
            </button>
          </div>
