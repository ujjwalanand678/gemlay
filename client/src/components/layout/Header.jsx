...
const Header = () => {
  ...
  return (
    <header className="w-full bg-[#0E3B3F] text-white font-[Inter]">
      {/* TOP BAR */}
      <div className="w-full bg-[#064D4F] text-[11px] py-2 flex justify-between px-6 md:px-8 tracking-wide">
      ...
      <div className="flex items-center justify-between py-4 px-5 md:px-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 select-none">
            <img src={logo} alt="Gemlay Logo" className="h-10 opacity-80" />
            <div className="leading-tight hidden md:block">
              <p className="text-xl font-semibold opacity-90 tracking-wide">
                GEMLAY
              </p>
              <p className="text-xs opacity-70 -mt-1">Pure Diamond Elegance</p>
            </div>
          </div>
        </div>
      ...
      <nav className="hidden md:flex items-center justify-center gap-10 py-4 border-t border-[#1F4C4C] text-sm text-gray-200 tracking-wide">
        <Link
          to="/new-arrivals"
          className="px-4 py-1 border border-teal-300 rounded-full text-teal-200 font-medium hover:bg-teal-300/10 transition"
        >
          New Arrivals
        </Link>

        <Link to="/rings" className="hover:text-white transition">
          Rings
        </Link>

        <Link to="/earrings" className="hover:text-white transition">
          Earrings
        </Link>

        <Link to="/pendants" className="hover:text-white transition">
          Pendants
        </Link>

        <Link to="/bangles-bracelets" className="hover:text-white transition">
          Bangles And Bracelets
        </Link>

        <Link to="/gold-coins-bars" className="hover:text-white transition">
          Gold Coin & Bars
        </Link>

        <Link to="/all-jewellery" className="hover:text-white transition">
          All Jewellery
        </Link>
